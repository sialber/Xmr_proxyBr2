...
# Quantos threads utilizam métodos síncronos (serviços).
# 30 é suficiente para instalação pequena, para uso real
# deve ser um pouco mais, diga 100-300.
...
# Hostname ou IP externo para expor
HOSTNAME = 'stratum.examplo.com'
